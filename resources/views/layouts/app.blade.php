                        ...
                        <div class="col-9">
                            <nav class='navbar navbar-expand-lg d-flex justify-content-end'>
                                <ul class='navbar-nav me-right  mb-2 mb-lg-0'>
                                    <li class='nav-item'>
                                        <a class='nav-link text-white'  href="{{ route('statistic.home') }}">Statistiques</a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link text-white' href="{{ route('players') }}">Mes joueurs</a>
                                    </li>
                                    <li class='nav-item'>
                                        <a class='nav-link text-white' href="{{ route('championships') }}">Mes
                                            championnats</a>
                                    </li>
                                    <li>
                                        <!-- Authentication -->
