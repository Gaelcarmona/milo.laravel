            ...
            @foreach ($players as $player)
                ...
                <tr>
                    ...
                    @if ($totalMatch != 0 && $results_for_players[$count]->count('*') != 0)
                        ...
                        <td class="d-none d-md-table-cell">{{ round(($championshipResults->pluck('kills')->flatten()->where('user_killed_id', $player->id)->count() /$results_for_players[$count]->count('*')) *100,2) }}
                            %
                        </td>
