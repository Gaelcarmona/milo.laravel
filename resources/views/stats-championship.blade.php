                            ...
                            @foreach ($decks as $deck)
                                ...
                                <tr>
                                    ...
                                    @if($totalMatch != 0 && $results_for_decks[$countDeck]->count('*') != 0)
                                        ...
                                        <td>{{ $results_for_decks[$countDeck]->where('place', 1)->count('place') }}</td>
                                        ...
                                        <td>{{ $results_for_decks[$countDeck]->pluck('kills')->flatten()->count() }}</td>
                                        <td>{{ $championshipResultsDeck->pluck('kills')->flatten()->where('user_killed_id', $deck->user->id)->count() }}</td>
